...
#include "quien_gana.hpp"

void cinco_movimientos_tira_afloja(stats& estadisticas)
{
    srand(time(nullptr));
    ...
    string movimientos[5] = {"Spock", "Piedra", "Tijera", "Lagarto", "Papel"};
    ...
    while(limite > victorias_jugador - victorias_bot and limite > victorias_bot - victorias_jugador){
        ...
        switch(movimiento_jugador){
            case 1: estadisticas.spock++; break;
            case 2: estadisticas.piedra++; break;
            case 3: estadisticas.tijera++; break;
            case 4: estadisticas.lagarto++; break;
        ...
        ganador = quien_gana(movimiento_jugador, movimiento_bot, 5);
    ...
    if(movimiento_jugador == 1) cinco_movimientos_tira_afloja(estadisticas);
    else cout << endl;
}

void cinco_movimientos_primero(stats& estadisticas)
{
    srand(time(nullptr));
    ...
    if(movimiento_jugador == 1) cinco_movimientos_primero(estadisticas);
    else cout << endl;
}

void cinco_movimientos_hasta(stats& estadisticas)
{
    srand(time(nullptr));
    ...
    if(movimiento_jugador == 1) cinco_movimientos_hasta(estadisticas);
    else cout << endl;
}